...
from news.tasks import send_mail_for_sub_every_week
...
def news_sender():
    ...
    for category in Category.objects.all():
        ...
        # пустой список для будущего формирования списка статей, разбитых по категориям + ссылка перехода на каждую статью
        ...
        # Третий цикл - до формирования письма (имя кому отправляем, получаем тут) и рассылка готового
